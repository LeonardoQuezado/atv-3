...
Após 2-3 minutos de execução, você deverá observar:
- Sensores publicando leituras a cada 60 segundos
- Serviço CAT calculando médias e exibindo número de leituras
- Alertas sendo disparados quando condições são atingidas
- Serviço Alarms exibindo notificações formatadas
